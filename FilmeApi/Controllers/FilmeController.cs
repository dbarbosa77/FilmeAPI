...
public class FilmeController : ControllerBase
{
    ...
    public IActionResult AdicionaFilme([FromBody] CreateFilmeDto filmeDto)
    {
        ...
        Console.WriteLine($"Feito a inclusão do filme {filmeDto.Titulo} de id {filme.Id} com sucesso.");
    ...
    {
        var filmeDto = _context.Filmes.Skip(skip).Take(take);
        return _mapper.Map<List<ReadFilmeDto>>(filmeDto);
    }
